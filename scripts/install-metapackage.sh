...
# Package installs will reconcile, but you can force an emmediate reconciliation using the kick command for the repo and/or package install, as follows:
# kctrl p repo kick -r app-repo -n installs
